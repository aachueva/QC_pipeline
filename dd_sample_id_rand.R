...
sample$rand.sample.id.org <- sample$sample.id.org[idx]
...
save(vcf_sample, file=paste0(path_res_folder_dp,'/VCF_NWD_subj_id_mapping_rand.RData'))
...
match.samples.on=c("submitted_subject_id", "rand.sample.id.org"),
